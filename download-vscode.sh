...
declare -A extensions=(
    ...
    ["vscode-builtin-shellscript"]="https://open-vsx.org/api/vscode/shellscript/1.45.1/file/vscode.shellscript-1.45.1.vsix"
    ...
    ["vscode-builtin-theme-dimmed"]="https://open-vsx.org/api/vscode/theme-dimmed/1.45.1/file/vscode.theme-dimmed-1.45.1.vsix"
    ...
    ["vscode-python"]="https://open-vsx.org/api/ms-python/python/2023.22.1/file/ms-python.python-2023.22.1.vsix"
)
